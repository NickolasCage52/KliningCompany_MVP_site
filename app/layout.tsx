...
export default function RootLayout({
  ...
  return (
    <html lang="ru" className={montserrat.variable} suppressHydrationWarning>
      ...
      <body className="min-h-screen flex flex-col font-sans antialiased m-0 p-0 lg:pt-[6.5rem] w-full max-w-full min-w-0 overflow-x-clip">
        <ScrollLockX />
        <OverflowDebug />
        <LocalBusinessJsonLd />
        <div className="w-full min-w-0 max-w-full overflow-x-clip flex flex-col flex-1">
        <Header />
